const config = {
  ...
  database: {
    url: "mongodb://localhost:27017/gameMonk"
  },
  textLocal: {
  ...
  defaultIntervalForAppointment:
    process.env.DEFAULT_INTERVAL_FOR_APPOINTMENT || 20,
  allowedIPs: ["127.0.0.1", "3.6.104.96", "13.232.196.126", "110.172.17.230"],
  allowedReferralDomains: ["game-monk.s3.ap-south-1.amazonaws.com"]
};
